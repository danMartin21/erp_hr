...
<div class="container" >
  ...
  <form method="post">
    ...
    <div class="form-group">
      <input type="text" class="form-control" id="email" placeholder="Enter Employee ID....." name="user" style="width: 300px">
    </div>
    <div class="form-group">
...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['id']=$row['id']; 
    ?>
    echo "<script>alert('Login Success!!'); window.location='dasboard.php'</script>";
    <?php 
    }
    else{ ?>
